...
export function TableHead({ className, ...props }: React.ThHTMLAttributes<HTMLTableCellElement>) {
  return (
    <th
      className={cn(
        'h-10 px-4 text-left align-middle text-[11px] font-bold text-slate-700 uppercase tracking-wider font-heading',
        className
      )}
      {...props}
    />
...
export function TableCell({ className, ...props }: React.TdHTMLAttributes<HTMLTableCellElement>) {
  return <td className={cn('p-4 align-middle text-xs sm:text-sm text-slate-900 font-sans', className)} {...props} />;
}
